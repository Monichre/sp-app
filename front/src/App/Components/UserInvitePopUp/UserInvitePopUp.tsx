...
const PopOverTitleBar = ({ onClick }: any) => (
  <TitleBar>
    <p>Invite Your Friends to Soundpruf</p>
    <div onClick={onClick}>
      <CloseCircleIcon />
    </div>
  </TitleBar>
...
export const UserInvitePopUp: React.SFC<UserInvitePopUpProps> = ({
  toggle,
  visible,
  currentUserName,
  isMobile
  ...
  <Popover
    content={
      <UserInviteForm currentUserName={currentUserName} close={toggle} />
    }
  ...
  >
    <span onClick={toggle}>
      <AddUserIcon /> {isMobile ? null : "Invite Friends"}
    </span>
  </Popover>
);
